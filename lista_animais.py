...
def gerando_animais():
    for professor in lista_professores:
        nome = professor['nome_animal']
        predador = professor['predador']
        venenoso = professor['venenoso']
        domestico = professor['domestico']
        professor = Professor(nome_professor=nome, formacao=predador, tempo_de_experiencia_em_anos=venenoso, area_de_atuacao=domestico)
        professor.save()
